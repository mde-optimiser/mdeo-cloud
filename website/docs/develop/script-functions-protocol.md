...
| `code` | string \| null | `null` | `unknown-object`, or `null` for any other failure |
...
00000000ffffff67656e7472696573f6ffff64617267739f9f63726566bf62696401ffff9f646e756c6cbfffffffffff
```
